...
def run_stability_loops(Npar=21, max_input=100, max_weight_scaling=5, stim_ori=0, sigma=30., sigma_broad=100., sigma_vip=30., sigma_in=30., spont_input=[2,2,2,10], run_input=[0,0,0,0], calc_freq=[0.], k=.04, n_power=2., savefile='data_par_loop.npz'):
    ...
    # save results
    W = connection_weights()
    np.savez(W_default=W, pv_frac=weight_frac, vip_scale=weight_scale, input_strenghts=input_strengths, \
